...
const PROOF_BUILDER_URL = process.env.CREDITCOIN_PROOF_BUILDER_URL || process.env.ATTESTCOIN_PROOF_API_URL || 'https://proof-gen-api.cc3-testnet.creditcoin.network';
