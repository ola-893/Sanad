      ...
      {autoPayEnabled && (
        <>
          ...
          <div className="space-y-2">
            ...
            >
              <Card className={`cursor-pointer ${paymentMethod === "wallet" ? "border-primary" : ""}`}>
                <CardContent className="p-4">
                  <div className="flex items-center gap-2">
                    <RadioGroupItem value="wallet" id="auto-wallet" />
                    <Label htmlFor="auto-wallet" className="flex items-center gap-2 cursor-pointer">
                      <Wallet className="h-4 w-4" /> Creditcoin Wallet
                    </Label>
                  </div>
                </CardContent>
              </Card>
