...
import { Menu, X, LayoutDashboard, CreditCard, User, LogOut, Loader2, Fingerprint, Wallet } from "lucide-react"
...
const borrowerNav = [
  ...
  { href: "/dashboard/borrower/loans", label: "My Loans", icon: Wallet },
